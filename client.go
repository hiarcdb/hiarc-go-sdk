...
// APIClient manages communication with the Hiarc API API v0.1.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.LegalHoldApi = (*LegalHoldApiService)(&c.common)
	c.RetentionPolicyApi = (*RetentionPolicyApiService)(&c.common)
